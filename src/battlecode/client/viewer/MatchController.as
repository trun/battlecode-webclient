package battlecode.client.viewer {
	...
	public class MatchController extends EventDispatcher {
		...
		[Bindable] private var _fps:uint = 0;
		[Bindable] private var _keyframeRate:uint = 0;
		
		[Bindable] private var _prevEnabled:Boolean = false;
		[Bindable] private var _nextEnabled:Boolean = false;
		[Bindable] private var _currentRound:uint = 0;
		
		[Bindable] private var _playing:Boolean = false;
		[Bindable] private var _fastForwarding:Boolean = false;
		
		[Bindable] private var _match:Match;
		[Bindable] private var _currentMatch:uint;
		private var matches:Vector.<Match>;
		
		[Bindable] private var _currentState:DrawState;
		private var keyframes:Vector.<DrawState>;
		
		[Bindable] private var _selectedRobot:DrawRobot;
		...
		public function get prevEnabled():Boolean { return _prevEnabled; }
		...
		[Bindable(event="propertyChange")]
		public function get currentRound():uint { return _currentRound; }
		...
		[Bindable(event="propertyChange")]
		public function get fastForwarding():Boolean { return _fastForwarding; }
		...
		[Bindable(event="propertyChange")]
		public function get currentState():DrawState { return _currentState; }
		
		[Bindable(event="propertyChange")]
		public function get match():Match { return _match; }
		
		[Bindable(event="propertyChange")]
		public function get totalMatches():uint { return matches.length; }
		
		[Bindable(event="propertyChange")]
		public function get currentMatch():uint { return _currentMatch; }
		...
		[Bindable(event="propertyChange")]
		public function get keyframeRate():uint { return _keyframeRate; }
		...
		[Bindable(event="propertyChange")]
		public function get selectedRobot():DrawRobot { return _selectedRobot; }
